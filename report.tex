...
また，1講座の先輩方の協力無しには私たちのプロセス設計は完成できませんでした．
プロセスの内容や発表に対し，的確なアドバイスをしていただきました．
...
\begin{thebibliography}{30}
    \bibitem{hexa} Hexa Research, 'Benzoic Acid Analysis', 2016 \url{https://www.hexaresearch.com/research-report/benzoic-acid-market}
    ...
    \bibitem{19952357}冨山 明男 and 片岡 勲 and 坂口 忠司 気泡の抗力係数に関する研究 : 第1報,静止液中単一気泡の抗力係数 \textit{日本機械学会論文集 B編}, \textbf{61}, 2357-2364, 1995
  \end{thebibliography}
