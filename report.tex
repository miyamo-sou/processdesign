...
ただし，トルエンをTol，ベンジルアルコールをBalc，ベンズアルデヒドをBald，安息香酸をBzAと表記している．これらの反応は全て酸化反応であり，触媒にはモリブデン酸マンガン\ce{MnMoO4}を用いることとした．これらの反応の反応速度定数を，表\ref{反応速度定数}に示す\cite{HOORN2005187}．
反応速度定数
\begin{table}[htbp]
  \centering
  \label{反応速度定数}
