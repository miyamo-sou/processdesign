...
ただし，トルエンをTol，ベンジルアルコールをBalc，ベンズアルデヒドをBald，安息香酸をBzAとしている．これらの反応は全て酸化反応であり，触媒には，酸化剤であるモリブデン酸マンガン\ce{MnMoO4}を用いることとした．これらの反応の反応速度定数は，表\ref{}のようである\cite{}．
\begin{table}
  \centering
  \label{}
  \caption{}
...
\begin{thebibliography}{10}
    ...
    \bibitem{謎資料} 第6回ソフトウェアツール学生コンテスト http://www.chemeng.titech.ac.jp/~sis_cont/dairokkai.html
