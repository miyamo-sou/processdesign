\documentclass[truesize=10.5pt,a4j]{jsreport}
...
ただし，トルエンをTol，ベンジルアルコールをBalc，ベンズアルデヒドをBald，安息香酸をBzAと表記している．これらの反応は全て酸化反応であり，触媒にはモリブデン酸マンガン\ce{MnMoO4}を用いることとした．これらの反応の反応速度定数はアレニウス式に従い，パラメータを表\ref{反応速度定数}に示す\cite{HOORN2005187}．
\begin{equation}
  k_j = A_j\exp(-\frac{E_j}{RT})
\end{equation}
\begin{table}[htbp]
  \centering
  \label{反応速度定数}
...
\begin{align*}
    ...
    &E_{\mathrm{g}} = 40.05 \, \si{\kilo \joule \per \mole} \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{c|c|cc|c}
      ...
      \hline
      \multirow{15}{*}{支出} & 原料コスト & トルエン & 10.4 & 10.4 \\
      \cline{2-5}
      & \multirow{10}{*}{装置コスト} & 晶析器 & 0.39 & \multirow{10}{*}{1.42} \\
      & & 反応器 & 0.34 & \\
      & & 熱交換器 & 0.33 & \\
      & & 抽出塔 & 0.14 & \\
      & & コンデンサ & 0.05 & \\
